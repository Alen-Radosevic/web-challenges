...
const catStartingFromIndexFiveExists = animalStrings.includes("cat exist", 5);
...
console.log("animal start width p: ", firstAnimalStartingWithLetterP);
