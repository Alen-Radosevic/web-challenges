...
switchButton.addEventListener("click", () => {
  const firstInputStartValue = firstInput.value;
  const secondInputStartValue = secondInput.value;
  firstInput.value = secondInputStartValue;
  secondInput.value = firstInputStartValue;
});
